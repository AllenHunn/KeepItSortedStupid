...
describe("SortedArray", () => {
    const kiss: SortedArray<number> = new SortedArray<number>();
    ...
    describe("find", () => {
        it("should be able to find a value", () => {
            const result: number = kiss.find(90);
            expect(result).equals(90);
        });

        it("should return null when not found", () => {
            const result: number = kiss.find(-10);
            expect(result).equals(null);
        });
    });
    ...
    describe("forEach", () => {
        it("should execute a function on each instance", () => {
            ...
            const ki: SortedArray<number> = new SortedArray<number>(testData);
