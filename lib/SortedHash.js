...
var SortedHash = /** @class */ (function () {
    ...
    SortedHash.prototype.forEachWithKey = function (func) {
        _.forEach(this.contents, function (node) { return func(node.key, node.value); });
    };
    SortedHash.prototype.map = function (func) {
        return _.map(this.contents, function (node) { return func(node.value); });
    };
    SortedHash.prototype.mapWithKey = function (func) {
        return _.map(this.contents, function (node) { return func(node.key, node.value); });
    };
